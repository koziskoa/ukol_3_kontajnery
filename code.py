...
from functions import choose_address, choose_containers, distance, load_coor, open_load, MAX_LIMIT
...
for coor_adresa in dict_address:
    ...
    for kont in dict_containers:
        #procházení slovníku kontejnerů pro uložení polohy
